                                ...
                                <div class="box-body no-padding">
                                    <ul class="nav nav-pills nav-stacked">
                                        <li class="active"><a href="#"><i class="fa fa-inbox"></i> Mis chats
                                            <span class="label label-primary pull-right">13</span></a>
                                        </li>
                                    </ul>
                                </div>
                                <!-- /.box-body -->
                                        ...
                                        <table class="table table-hover table-striped">
                                            <tbody>
                                                ...
                                                <tr onclick="#">
                                                    ...
                                                    <td class="mailbox-name"><a href="chat.php?usuario=<?php echo $var ?>&l=1"><?php echo $us['Nombres']?> <?php echo $us['Apellidos']?></a></td>
