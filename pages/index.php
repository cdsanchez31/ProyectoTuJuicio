                  ...
                  <!-- Main row -->
                    <div class="row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <span class="btn btn-danger btn-raised  btn-file btn-block">
                                                    <i class="fa fa-archive"></i> <span>Adjuntar</span>
                                                ...
                                                <div class="col-md-2">
                                                    <button type="submit" name="publicar" class="btn btn-danger btn-raised btn-block">
                                                        <i class="fa fa-check"></i> <span>Publicar</span>
                                                    </button>
                                                </div>
                                                <!--<input type="file" name="foto" id="file-1" class="inputfile inputfile-1" data-multiple-caption="{count} files selected"/> -->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-DANGER">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Enlaces de Interes</h3>
                                </div>
                            </div>
                        </div>
                        <!-- /.col -->
