...
<html>
    ...
    <body class="hold-transition skin-red sidebar-mini">
        <div class="wrapper">
            ...
            <?php
            $miuser = IDU("SELECT * FROM usuario WHERE IdUsuario = ".$_SESSION['idusuario']);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                                ...
                                <form role="form" method="post" action="" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group col-md-4">
                                            <span class="btn btn-danger btn-raised  btn-file btn-block">
                                                <i class="fa fa-archive"></i> <span>Cambiar Avatar</span>
                            ...
                            if(isset($_POST['actualizar']))
                            {
                                ...
                                $comprobar = mysqli_num_rows(IDU("SELECT * FROM usuario WHERE Usuario = ".$_SESSION['usuario']." AND IdUsuario != ". $_SESSION['idusuario']));
                                if($comprobar == 0){

                                    $type = 'jpg';
                                    $rfoto = $_FILES['avatar']['tmp_name'];
                                    $name = $_SESSION['idusuario'].'.'.$type;
                                    ...
                                    $sql = IDU("UPDATE usuario SET  Usuario = '$usuario', Email = '$email', Telefono = '$telefono', Celular = '$celular',  Avatar = '$nombrea' WHERE IdUsuario = ".$_SESSION['idusuario']);

                                    if($sql) {echo "<script type='text/javascript'>window.location='SettingsProfile.php?id=$_SESSION[idusuario]';</script>";}
