...
<html>
    ...
    <body class="hold-transition register-page">
        <div class="register-box col-md-6 pull-left">
            ...
            <br>
            <div class="register-box col-md-6 pull-right">
                <form>
                    <div class="register-box-body pull-right col-md-12">
                        <div class="form-group has-feedback">
                            <input type="text" name="tarjetap" class="form-control" placeholder="Tarjeta Profesional" value="<?php echo $_POST['TarjetaProfesional']; ?>" required>
                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="text" name="unipre" class="form-control" placeholder="Universidad Pregrado" value="<?php echo $_POST['UniveridadPregrado']; ?>" required>
                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="text" name="unipro" class="form-control" placeholder="Universidad Postgrado" value="<?php echo $_POST['UniversidadPostgrado']; ?>" required>
                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="text" name="expl" class="form-control" placeholder="Experiencia Laboral" value="<?php echo $_POST['ExperienciaLaboral']; ?>" required>
                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="text" name="especialidad" class="form-control" placeholder="Especialidad" value="<?php echo $_POST['IdEspecialidad']; ?>" required>
                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
            ...
            if(isset($_POST['registrar'])) {
                ...
                $ctarjeta = "SELECT * FROM usuario WHERE TarjetaProfesional = '$tarjetap'";
                $comprobartarjeta = Consultar($cusuario);
                ...
                if ($comprobarusuario >= 1) {
                    ...
                    if ($comprobaremail >= 1) {
                        ...
                        if ($comprobartarjeta >= 1) {
                            ?>
                            <br>
                            <div class="alert alert-danger alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;
                                </button>
                                El numero de tarjeta profesional ya esta en uso, por favor verifique de nuevo
                            </div>
                            <?php
                        } else {
